      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden', padding: '20px', gap: '12px' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          ...
          <div style={{ display: 'flex', gap: '8px', alignItems: 'center' }}>
            {savingRaw && <span style={{ color: '#888', fontSize: '12px' }}>已儲存</span>}
            <button
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'start', marginBottom: '12px' }}>
              <div>
                ...
                <div style={{ color: '#888', fontSize: '12px', lineHeight: 1.4 }}>
                  開啟敲擊模式後，按下 Space 鍵可將當前播放時間套用到下一行歌詞。
                </div>
              </div>
              <div style={{ textAlign: 'right' }}>
                <div style={{ color: '#aaa', fontSize: '12px', marginBottom: '4px' }}>目前熱鍵：Space</div>
                <button
